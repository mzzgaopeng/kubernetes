...
type Runtime interface {
	...
	SyncPod(pod *v1.Pod, apiPodStatus v1.PodStatus, podStatus *PodStatus, pullSecrets []v1.Secret, backOff *flowcontrol.Backoff, rootDirectory string,  emptyLogDirectory string) PodSyncResult
