...
func (r *Mock) SyncPod(pod *v1.Pod, apiStatus v1.PodStatus, status *PodStatus, secrets []v1.Secret, backOff *flowcontrol.Backoff, rootDirectory string,  emptyLogDirectory string) PodSyncResult {
