...
func RegisterConversions(s *runtime.Scheme) error {
        if err := s.AddGeneratedConversionFunc((*v1alpha1.CmosSchedulerConfiguration)(nil), (*config.CmosSchedulerConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CmosSchedulerConfiguration_To_config_CmosSchedulerConfiguration(a.(*v1alpha1.CmosSchedulerConfiguration), b.(*config.CmosSchedulerConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CmosSchedulerConfiguration)(nil), (*v1alpha1.CmosSchedulerConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CmosSchedulerConfiguration_To_v1alpha1_CmosSchedulerConfiguration(a.(*config.CmosSchedulerConfiguration), b.(*v1alpha1.CmosSchedulerConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CmosSchedulerConfiguration_To_config_CmosSchedulerConfiguration(in *v1alpha1.CmosSchedulerConfiguration, out *config.CmosSchedulerConfiguration, s conversion.Scope) error {
	out.PredicateStep = in.PredicateStep
	out.NodeListLengthThreshold = in.NodeListLengthThreshold
	return nil
}

// Convert_v1alpha1_CmosSchedulerConfiguration_To_componentconfig_CmosSchedulerConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_CmosSchedulerConfiguration_To_config_CmosSchedulerConfiguration(in *v1alpha1.CmosSchedulerConfiguration, out *config.CmosSchedulerConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_CmosSchedulerConfiguration_To_config_CmosSchedulerConfiguration(in, out, s)
}

func autoConvert_config_CmosSchedulerConfiguration_To_v1alpha1_CmosSchedulerConfiguration(in *config.CmosSchedulerConfiguration, out *v1alpha1.CmosSchedulerConfiguration, s conversion.Scope) error {
	out.PredicateStep = in.PredicateStep
	out.NodeListLengthThreshold = in.NodeListLengthThreshold
	return nil
}

// Convert_componentconfig_CmosSchedulerConfiguration_To_v1alpha1_CmosSchedulerConfiguration is an autogenerated conversion function.
func Convert_config_CmosSchedulerConfiguration_To_v1alpha1_CmosSchedulerConfiguration(in *config.CmosSchedulerConfiguration, out *v1alpha1.CmosSchedulerConfiguration, s conversion.Scope) error {
	return autoConvert_config_CmosSchedulerConfiguration_To_v1alpha1_CmosSchedulerConfiguration(in, out, s)
}
...
func autoConvert_v1alpha1_KubeSchedulerConfiguration_To_config_KubeSchedulerConfiguration(in *v1alpha1.KubeSchedulerConfiguration, out *config.KubeSchedulerConfiguration, s conversion.Scope) error {
	...
	out.BindTimeoutSeconds = (*int64)(unsafe.Pointer(in.BindTimeoutSeconds))
        if err := Convert_v1alpha1_CmosSchedulerConfiguration_To_config_CmosSchedulerConfiguration(&in.CmosConfiguration, &out.CmosConfiguration, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_KubeSchedulerConfiguration_To_v1alpha1_KubeSchedulerConfiguration(in *config.KubeSchedulerConfiguration, out *v1alpha1.KubeSchedulerConfiguration, s conversion.Scope) error {
	...
	out.FailureDomains = in.FailureDomains
	out.BindTimeoutSeconds = (*int64)(unsafe.Pointer(in.BindTimeoutSeconds))
        if err := Convert_config_CmosSchedulerConfiguration_To_v1alpha1_CmosSchedulerConfiguration(&in.CmosConfiguration, &out.CmosConfiguration, s); err != nil {
		return err
	}
	return nil
}
